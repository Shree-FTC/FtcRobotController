...
@TeleOp(name="Intake Mechanism 2", group="Linear Opmode")
public class SorterMech5 extends LinearOpMode {
    ...
    private static final double PURPLE_PIPE_POSITION_1 = 0.2;
    private static final double GREEN_PIPE_POSITION_1  = 0.8;
    private static final double NEUTRAL_POSITION_1     = 0.5;

    private static final double PURPLE_PIPE_POSITION_2 = 0.8;
    private static final double GREEN_PIPE_POSITION_2  = 0.2;
    private static final double NEUTRAL_POSITION_2     = 0.5;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Servo1 Position", "%.2f", sorter1.getPosition());
            telemetry.addData("Servo2 Position", "%.2f", sorter2.getPosition());
    ...
    public void setPurplePipe() {
        sorter1.setPosition(PURPLE_PIPE_POSITION_1);
        sorter2.setPosition(PURPLE_PIPE_POSITION_2);
    }

    public void setGreenPipe() {
        sorter1.setPosition(GREEN_PIPE_POSITION_1);
        sorter2.setPosition(GREEN_PIPE_POSITION_2);
    }

    public void setNeutral() {
        sorter1.setPosition(NEUTRAL_POSITION_1);
        sorter2.setPosition(NEUTRAL_POSITION_2);
    }
}
