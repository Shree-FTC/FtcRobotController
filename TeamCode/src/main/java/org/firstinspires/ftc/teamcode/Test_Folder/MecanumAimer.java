...
import org.firstinspires.ftc.teamcode.OLD.MyTargetProcessor;
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.left_trigger > 0.2) {
                ...
                if (targetProcessor.targetDetected()) {
                    ...
                    telemetry.addData("Angle Error (deg)", angleError);
                ...
                telemetry.addData("Scan", "Hold LEFT TRIGGER");
            }
