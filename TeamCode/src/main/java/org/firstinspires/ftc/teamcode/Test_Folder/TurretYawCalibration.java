...
@TeleOp(name="TurretYawCalibration", group="Calibration")
public class TurretYawCalibration extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        turretYaw.setPosition(calibratedPositions[calibrationStep]);
